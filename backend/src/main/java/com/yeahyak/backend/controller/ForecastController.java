...
/**
 * 발주 예측 API 처리하는 컨트롤러입니다.
 */
@RestController
@RequestMapping("/api/forecast/order")
...
public class ForecastController {
  ...
  public ResponseEntity<ApiResponse<List<ForecastResponse>>> forecastOrder(
      @RequestParam("file") MultipartFile file
  ) {
    List<ForecastResponse> result = forecastService.forecastOrder(file);
