...
public class AuthController {
  ...
  public ResponseEntity<ApiResponse<String>> signup(
      @Valid @RequestBody PharmacySignupRequest request) {
    authService.pharmacySignup(request);
  ...
  public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request,
    ...
    PharmacyLoginResponse pharmacyLoginResponse = authService.login(request);
    User user = userRepository.findByEmail(pharmacyLoginResponse.getUser().getEmail())
        .orElseThrow(() -> new IllegalArgumentException("사용자를 찾을 수 없습니다."));
    ...
    return ResponseEntity.ok(Map.of(
        ...
        "data", Map.of(
            ...
            "profile", pharmacyLoginResponse.getProfile()
        )
    ));
  }
  ...
  public ResponseEntity<?> updatePharmacy(
    ...
    return ResponseEntity.ok(Map.of(
        ...
        "data", Map.of(
            ...
            "pharmacyRequestStatus", updatedProfile.getStatus()
        )
    ));
  }
