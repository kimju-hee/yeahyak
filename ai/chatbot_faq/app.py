...
from flask import Flask, jsonify, request  # 플라스크
...
#     print(
#         "🚀 약사봇 Flask 서버 실행 중... (http://localhost:5000/chat)  import os.py:100 - faq_server.py:101"
#     )
#     # 챗봇 실행 시 나오는 문구
#     print("안녕하세요! 약사봇입니다. - faq_server.py:76")
#     print(
#         "[본사 정책 관련] [운영 프로세스 관련] [반복 상담/고객 응대 관련] [복약지도 관련] [반품/교환/클레임 관련]  import os.py:76 - faq_server.py:77"
#     )
