...
//   stock: number;
//   suggested: number;
//   pharmacyRequestStatus: '부족' | '정상' | '과다';
// }
...
//       { text: '과다', value: '과다' },
//     ],
//     onFilter: (value, record) => record.pharmacyRequestStatus === value,
//     render: (pharmacyRequestStatus) => {
//       const color = pharmacyRequestStatus === '부족' ? 'volcano' : pharmacyRequestStatus === '정상' ? 'green' : 'geekblue';
//       return <Tag color={color}>{pharmacyRequestStatus}</Tag>;
//     },
//   },
// ];
