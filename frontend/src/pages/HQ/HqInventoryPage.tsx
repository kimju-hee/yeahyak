...
// // 입고 처리 폼 컴포넌트
// const InventoryInForm: React.FC<{
//   product: ProductList;
...
// // 재고 거래 내역 테이블 컴포넌트
// const InventoryTransactionTable: React.FC<{
//   data: InventoryTx[];
//   loading?: boolean;
// }> = ({ data, loading }) => {
...
//   const [inventoryInLoading, setInventoryInLoading] = useState(false);
...
//   // 재고 거래 내역 조회
//   const fetchInventoryTransactions = async (productId: number) => {
//     setTxLoading(true);
//     try {
...
//     setIsModalOpen(true);
//     await fetchInventoryTransactions(product.productId);
//   };
...
//   // 입고 처리
//   const handleInventoryIn = async (amount: number) => {
//     if (!selectedProduct) return;

//     setInventoryInLoading(true);
//     try {
...
//         message.success('입고 처리가 완료되었습니다.');
//         // 재고 거래 내역 다시 조회
//         await fetchInventoryTransactions(selectedProduct.productId);
...
//               onSubmit={handleInventoryIn}
//               loading={inventoryInLoading}
//             />
//             <InventoryTransactionTable data={txData} loading={txLoading} />
//           </div>
//         )}
//       </Modal>
//     </>
