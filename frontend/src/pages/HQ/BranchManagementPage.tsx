...
export default function BranchManagementPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "lastCharged",
      sorter: (a: any, b: any) => new Date(a.lastCharged).getTime() - new Date(b.lastCharged).getTime(),
    },
    {
      title: "충전",
      key: "charge",
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        ...
        <Col span={6}><Card><Statistic title="휴점" value={pausedCount} valueStyle={{ color: "orange" }} /></Card></Col>
